...
public class BookRestController {
    ...
    public List<Book> getAll(){
        ...
        booksList.add(new Book(501, "Head First Java", 439.75));
        booksList.add(new Book(502, "Spring in Action", 340.75));
        booksList.add(new Book(503, "Hibernate in Action", 355.75));
        return booksList;
    }
